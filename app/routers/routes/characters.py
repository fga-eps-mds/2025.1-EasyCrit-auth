...
@router.get(
    '/{character_id}', response_model=CharacterPublic, dependencies=[Depends(check_auth_token)], status_code=status.HTTP_200_OK
)
...
# Update a character
@router.patch(
    '/{character_id}', response_model=CharacterPublic, status_code=status.HTTP_200_OK
)
